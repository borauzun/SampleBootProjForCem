 ...
 * fdp				: Will be filled if only the payment is future dated payment. Future payment details
 * @returns 
 ...
 * Sample 5 : International Payment   , UK GBP Account to Turkey GBP Account
 * Sample 6 : International Payment   , UK GBP Account to Turkey TRY Account
 */
@Data
@AllArgsConstructor
@NoArgsConstructor
...
public class InternationalPaymentInitiationRequest {
